...
$language['backend.menu.af.analytics.tip']       = 'Google Analytics Tracking ID (G-XXXXXXX)';
...
$language['backend.menu.entry1.sub13.guest.browse.a']      = 'Browse Audio Access';
$language['backend.menu.entry1.sub13.guest.browse.a.tip']  = 'Allow access to browse audio page.';
...
$language['backend.menu.entry1.sub13.guest.view.a']        = 'View Audio Access';
$language['backend.menu.entry1.sub13.guest.view.a.tip']    = 'Allow access to viewing audio page.';
...
$language['backend.menu.entry2.sub1.google.an.tip']      = 'Google Analytics tracking ID (G-XXXXXXX)';
...
$language['backend.menu.entry1.sub7.file.short']            = 'Short Uploads';
$language['backend.menu.entry1.sub7.file.short.tip']        = 'This controls if uploading of short video files is allowed. Also sets the allowed short video file formats and maximum file size limit. ' . $language['backend.menu.entry1.sub7.file.limit'];
$language['backend.menu.entry1.sub7.short.up.store']        = 'Keep uploaded video shorts source files stored on the server';
$language['backend.menu.entry1.sub7.short.up.del']          = 'Delete video shorts source files after being uploaded';
$language['backend.menu.es.s']                              = 'Shorts Encoding';
$language['backend.menu.entry1.sub11.sitemap.short']        = 'Shorts Sitemap';
$language['backend.menu.entry1.sub11.sitemap.short.tip']    = 'Configure video shorts sitemap options. Max. entries sets the limit of entries per sitemap file (should not exceed 50000)';
$language['backend.menu.entry1.sub11.sitemap.rebuild.s']    = 'Rebuild Shorts Sitemap';
$language['backend.menu.entry1.sub11.sitemap.inc.short']    = 'Include Shorts';
$language['backend.menu.entry1.sub11.sitemap.inc.short.pl'] = 'Include Short Playlists';
$language['backend.menu.cd.s']                              = 'Short Transfers';
$language['backend.menu.fm.s']                              = 'Short Files';
$language['backend.menu.fu.s']                              = 'Short Upload';
$language['backend.menu.entry6.sub6.log.s.conv']            = 'Log video shorts encoding attempts';
$language['backend.menu.entry3.sub2.limit.short']           = 'Short File Limit';
$language['backend.menu.entry3.sub2.limit.short.tip']       = 'This controls the maximum file size of a single uploaded video short file.';

$language['backend.menu.entry6.total.s']    = 'Total Shorts';
$language['backend.menu.entry6.active.s']   = 'Active Shorts';
$language['backend.menu.entry6.inactive.s'] = 'Suspended Shorts';
$language['backend.menu.entry6.pending.s']  = 'Pending Shorts';
$language['backend.menu.entry6.flag.s']     = 'Flagged Shorts';
$language['backend.menu.entry6.featured.s'] = 'Featured Shorts';
$language['backend.menu.entry6.public.s']   = 'Public Shorts';
$language['backend.menu.entry6.private.s']  = 'Private Shorts';
$language['backend.menu.entry6.personal.s'] = 'Personal Shorts';
$language['backend.menu.entry6.today.s']    = 'Shorts Uploaded Today';
$language['backend.menu.entry6.week.s']     = 'Shorts Uploaded This Week';
$language['backend.menu.entry6.month.s']    = 'Shorts Uploaded This Month';
$language['backend.menu.entry6.year.s']     = 'Shorts Uploaded This Year';
//$language['backend.menu.entry6.hq.s']       = 'MP4/HQ Shorts';
//$language['backend.menu.entry6.mobile.s']   = 'MP4/Mobile Shorts';
$language['backend.menu.entry2.sub7.short']       = 'Shorts Module';
$language['backend.menu.entry2.sub7.short.tip']   = 'Enable or disable all shorts related functions';
$language['backend.menu.entry6.sub6.log.respond'] = 'Responding';

$language['backend.menu.no.categ.banners'] = 'No category banners found at Advertising > Banner Ads > Per Category.';
$language['backend.menu.no.categ.file']    = 'No banners found at Advertising > Banner Ads > Per File.';
$language['backend.menu.no.video.banners'] = 'No video ads found at Advertising > Player Ads > Video JS Ads.';
