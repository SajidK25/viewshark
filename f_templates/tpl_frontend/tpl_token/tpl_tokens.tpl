...
{if $smarty.get.rg eq "" and $smarty.get.rp eq ""}
	{include file="tpl_frontend/tpl_token/tpl_overview.tpl"}
{else}
	{$html_payouts}
{/if}
</div>
...
{if $smarty.get.rp}
	{include file="tpl_frontend/tpl_token/tpl_tokens_js.tpl"}
{elseif $smarty.get.rg}
	{include file="tpl_frontend/tpl_token/tpl_tokensrg_js.tpl"}
{/if}
</script>
