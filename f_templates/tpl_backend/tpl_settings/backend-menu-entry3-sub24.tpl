	...
	<form id="ct-set-form" action="">
	    ...
	    {generate_html bullet_id="ct-bullet2" input_type="server_paths_short" entry_title="backend.menu.entry6.sub1.conv.path" entry_id="ct-entry-details2" input_name="" input_value="" bb=1}
	    </div>
	    <div class="vs-column half fit vs-mask">
	    {generate_html bullet_id="ct-bullet1" input_type="switch" entry_title="backend.menu.entry6.sub1.conv.que" entry_id="ct-entry-details1" input_name="backend_menu_entry6_sub1_conv_que" input_value=$conversion_short_que bb=1}
	    </div>
	    <div class="clearfix"></div>
	    <div class="wdmax top-bottom-padding left-float s-wrap">
